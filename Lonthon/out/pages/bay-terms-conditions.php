...
<div class='well'>
<p>Welcome to <?php echo domain; ?>. The following Terms of Service govern your (and any person or entity you enable/allow access through your access) access and use of this website ('Site'), the contents contained herein ('Contents') and the services offered on the Site ('Services').</p>
...
<p>The <b>use</b> of this website is subject to the following Terms of Service:</p>
<p>
<strong>1. Acceptance of Terms of Service</strong><br>
1.1 In order to browse, use and/or access the Site and/or the Services you are required to agree to, comply with and be bound by these Terms of Service. You will be deemed to have accepted these Terms of Service by browsing, viewing, accessing and/or using the Site and/or the Services offered on the Site.
</p>
<p>1.2 If you disagree with any part of these Terms of Service, please do not continue to browse, use and/or access the Site and/or the Services.</p>
<p>1.3 In addition to these, there may be additional Terms of Service which apply to individual Services which you will be deemed to have accepted if you register for such Service.</p>
<p>
...
<p>2.2 You agree to access/use the Site and/or Services only for purposes that are expressly permitted by (i) these Terms of Service and (ii) any applicable law, regulation, guideline or instruction from <?php echo domain; ?>, the industry regulator or any other competent authority or any policy adopted by <?php echo domain; ?> with regard to the acceptable access/use of the Site and/or Services.</p>
<p>
<strong>3. Prohibited use of the Site, Services and/or Contents</strong><br>
3.1 You specifically agree not to access/use (or attempt to access/use) any part of the Site and/or Services through any form of automated means (including use of scripts or web crawlers) and shall ensure that you comply with, in addition to these Terms of Service, instructions set out in relation to the access/use of any part of the Site and/or Services.
</p>
...
<p>(a) Copy, disclose, modify, reformat, display, distribute, sell, perform, publish, transfer, link to, reverse engineer or decompile or otherwise make available any part of the Site and/or Services except as set out in these Terms of Service.</p>
...
<p>(e) Collect and process others personal data except in accordance with applicable data protection law and these Terms of Service.</p>
...
<p>4.2 If you do not wish to register, we may not collect any personal information from you and you may visit our site anonymously. However, you will be bound by these Terms of Service with regard to access/use of this Site and/or Services.</p>
...
<p>6.2 You are only allowed to access/use the Site and/or Services as set out in these Terms of Service. If you wish to access/use the Contents or any part thereof for any other purpose other than reviewing it on the Site then you will be required to obtain the prior written permission of the owner of the rights in that material. All rights are expressly reserved.</p>
<p>
...
<p>(b) If you are dissatisfied or you do not agree with any part of the Site, Services, Contents and/or any of these Terms of Service, your sole and exclusive remedy is to discontinue your use/access of this Site, Services and/or Contents.</p>
...
<p>11.2 <?php echo domain; ?> reserves the right to review, revise, amend and/or change the Services, Contents, Site, its policies and/or these Terms of Service at any time without any prior notice and you will be deemed to have been bound by such revision, amendment or change by continuing to use/access the Site, Services and/or Contents.</p>
</div>
</div>
