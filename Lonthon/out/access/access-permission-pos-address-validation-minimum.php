...
{
if($_SESSION['memberlevel'] >= 1 and $_SESSION['memberlevel'] <= 4 and isset($_SESSION['POS_ADMIN_USERNAME']))
{
$addressVarification = new ebapps\login\registration_page();
$addressVarification->sorryAddressVerifyRequired(); 
}
}
?>