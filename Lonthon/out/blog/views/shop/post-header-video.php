...
$postArticle .="<header class='blog_entry-header clearfix hidden-sm hidden-xs'>";
...
{
$postArticle .= "<div class='video-container'>";
$postArticle .= "<video class='responsive-video' autoplay controls>";
$postArticle .= "<source type='video/mp4' src='".hostingName.$contents_video_link."'>";
$postArticle .= "<source type='video/quicktime' src='".hostingName.$contents_video_link."'>";
$postArticle .= "<source type='video/mpeg' src='".hostingName.$contents_video_link."'>";
$postArticle .= "</video>";
$postArticle .= "</div>";
}
elseif (!empty($contents_video_link))
{
$postArticle .= "<div class='bs-example' data-example-id='responsive-embed-16by9-iframe-youtube'>";
$postArticle .= "<div class='embed-responsive embed-responsive-16by9'>";
$postArticle .= "<iframe class='embed-responsive-item' src='";
$postArticle .= hypertext.$contents_video_link;
$postArticle .= "' allowfullscreen loading='lazy'></iframe>";
$postArticle .= "</div>";
$postArticle .= "</div>";
}
$postArticle .="</div>";
