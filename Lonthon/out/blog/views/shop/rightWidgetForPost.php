...
$rightColumn .="<li>";
$objThumb = new ebapps\blog\blog();
$objThumb -> rightBarAllCategory();
...
$rightColumn .="'><img class='img-responsive' alt='".$objThumb->metaVisulString($contents_og_image_title)."' src='";
