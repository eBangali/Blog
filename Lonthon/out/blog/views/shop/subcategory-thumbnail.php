...
$wRiter -> contents_thurmnail_subcategory($category,$subcategory);
if($wRiter->eBData)
{
...
$writer .="<h2>".$wRiter->visulString($subcategory)."</h2>";
$writer .="</div>";
$writer .="</li>";
$writer .="</ul>";
$writer .="</div>";
...
{
$writer .="<a  class='product-image' href='";
$writer .=outContentsLink."/contents/solve/$contents_id/".$wRiter->seoUrl($contents_og_image_title)."/";
$writer .="'><img alt='".$wRiter->metaVisulString($contents_og_image_title)."' src='";
...
$writer .="<a  href='".outContentsLink."/contents/solve/$contents_id/".$wRiter->seoUrl($contents_og_image_title)."/' class='eb-cart-back'><span>Read More</span></a>";
$writer .="</div>";
$writer .="</div>";
$writer .="</div>";
$writer .="</div>";
