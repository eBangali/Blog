...
$ebmeta.="<meta property='og:title' content='".$siteTitle->metaVisulString($business_title_two)."' />\n";
$ebmeta.="<meta property='og:description' content='".$siteTitle->metaVisulString($business_title_two)."' />\n";
...
$ebmeta.="<meta name='twitter:title' content='".$siteTitle->metaVisulString($business_title_two)."'>\n";
$ebmeta.="<meta name='twitter:description' content='".$siteTitle->metaVisulString($business_title_two)."'>\n";
...
$ebmeta.="<title>".$siteTitle->visulString($business_title_two)."</title>\n";
$ebmeta.="<meta name='description' content='".$siteTitle->metaVisulString($business_title_two)."' />\n";
echo $ebmeta;
}
}
}
