...
(function(jQuery, window, document, undefined) {
	var ElevateZoom = {
		...
		startZoom: function() {
			...
			self.zoomContainer = jQuery('<div class="zoomContainer hidden-sm hidden-xs" style="-webkit-transform: translateZ(0);position:absolute;left:' + self.nzOffset.left + 'px;top:' + self.nzOffset.top + 'px;height:' + self.nzHeight + 'px;width:' + self.nzWidth + 'px;"></div>');
			...
			if (self.options.zoomType != "inner") {
				self.zoomLens = jQuery("<div class='zoomLens hidden-sm hidden-xs' style='" + self.lensStyle + self.lensRound + "'>&nbsp;</div>").appendTo(self.zoomContainer).click(function() {
			...
			self.zoomWindowContainer = jQuery('<div/>').addClass('zoomWindowContainer hidden-sm hidden-xs').css("width", self.options.zoomWindowWidth);
