      ...
      <div class='row'>
        <div class='col-md-3 col-sm-6'>
          <div class='footer-column pull-left'>
            ...
            <ul class='links'>
              ...
              <li><a  href='<?php echo outPagesLink; ?>/shipment-delivery.php' title='Shipment'><span>Shipment</span></a></li>
        ...
        <div class='col-md-3 col-sm-6'>
          <div class='footer-column pull-left'>
            ...
            <?php if(!mysqli_connect_errno()){ ?>
              ...
              <li class='last'><a  href='<?php echo outAccessLink; ?>/access-update-account-information.php' title='Account Settings'>Account Settings </a></li>
              <?php } ?>
            </ul>
          </div>
        </div>
        <div class='col-md-3 col-sm-6'>
          <div class='footer-column pull-left'>
            ...
            <ul class='links'>
            <?php if(!mysqli_connect_errno()){ ?>
            <li><a  href='<?php echo outPagesLink; ?>/terms-conditions.php' title='Terms of service'><span>Terms of service</span></a></li>
